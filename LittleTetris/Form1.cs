...
namespace LittleTetris
{
    public partial class Form1 : Form
    {
        ...
        public void SetShape()
        {
            ...
            switch (val)
            {
                case 0: Shape = new [,] { { 2, 3, 4, 5 }, { 8, 8, 8, 8 } }; break;
                case 1: Shape = new [,] { { 2, 3, 2, 3 }, { 8, 8, 9, 9 } }; break;
                case 2: Shape = new [,] { { 2, 3, 4, 4 }, { 8, 8, 8, 9 } }; break;
                case 3: Shape = new [,] { { 2, 3, 4, 4 }, { 8, 8, 8, 7 } }; break;
                case 4: Shape = new [,] { { 3, 3, 4, 4 }, { 7, 8, 8, 9 } }; break;
                case 5: Shape = new [,] { { 3, 3, 4, 4 }, { 9, 8, 8, 7 } }; break;
                case 6: Shape = new [,] { { 3, 4, 4, 4 }, { 8, 7, 8, 9 } }; break;
            }
        }
